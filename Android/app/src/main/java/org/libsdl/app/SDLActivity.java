...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    // Keep JNI-reflected bridge classes reachable so they are present in dex.
    @SuppressWarnings("unused")
    private static final String SDL_INPUT_CONNECTION_CLASS_NAME = "org.libsdl.app.SDLInputConnection";
    static {
        // Force class-loader resolution early without compile-time type dependency.
        try {
            Class.forName(SDL_INPUT_CONNECTION_CLASS_NAME, false, SDLActivity.class.getClassLoader());
        } catch (Throwable ignored) {
            // Logged later where startup diagnostics are emitted.
        }
    }
